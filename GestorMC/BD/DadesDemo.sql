...
-- =========================================================================
-- 3. HABILITATS (Màxim 4 per personatge)
-- =========================================================================

-- Accions per als Personatges Jugables (Per provar estats)
INSERT INTO Accio (id, id_objectiu, nom, descripcio, icona) VALUES 
(10, 2, 'Còctel a la Illa', 'Un combinat sospitós que enverina l''enemic', 'cocktail.png'),
(11, 2, 'Xantatge de Menors', 'Deixa l''enemic atordit per la pressió social', 'xantatge.png'),
(20, 2, 'Twitter Roast', 'Un tuit tan incendiari que crema l''enemic', 'twitter.png'),
(21, 2, 'Fake News', 'Confon l''enemic fins a atordir-lo', 'fakenews.png');

-- Accions per al Mercader Jueu (ID 3) i Jueu Final Form (ID 4)
INSERT INTO Accio (id, id_objectiu, nom, descripcio, icona) VALUES 
(60, 5, 'Plaga de Llagostes', 'Invoca un eixam que danya a tot l''equip enemic', 'llagostes.png'),
...
-- Assignació d'habilitats a Jeffrey Epstein (ID 1) -> Prova Enverinat (1) i Atordit (3)
INSERT INTO Habilitat (id_accio, id_personatge) VALUES 
(10, 1), 
(11, 1);

-- Assignació d'habilitats a Donald Trump (ID 2) -> Prova Cremat (2) i Atordit (3)
INSERT INTO Habilitat (id_accio, id_personatge) VALUES 
(20, 2), 
(21, 2);
...
-- Efectes Jugables:
-- 10: Còctel a la Illa (Enverinat ID 1)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(100, 10, 'Venè d''illa', 100, NULL, 1, 1, 3, TRUE);

-- 11: Xantatge de Menors (Atordit ID 3)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(110, 11, 'Paràlisi social', 80, NULL, 3, 1, 1, TRUE);

-- 20: Twitter Roast (Cremat ID 2)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(200, 20, 'Burn verbal', 100, NULL, 2, 1, 2, TRUE);

-- 21: Fake News (Atordit ID 3)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(210, 21, 'Confusió mediàtica', 70, NULL, 3, 1, 1, TRUE);


-- Efectes Enemics:
-- 60: Plaga de Llagostes (Dany de vida 1)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(600, 60, 'Dany d''eixam', 100, 1, NULL, 40, 0, FALSE);

-- 61: Clarí del Xofar (Atordit ID 3)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(610, 61, 'Atordiment sonor', 60, NULL, 3, 1, 1, TRUE);

-- 62: Pacte d'Abraham (Defensa ID 3)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(620, 62, 'Protecció divina', 100, 3, NULL, 50, 3, TRUE);

-- 63: Interès Compost (Vida ID 1 + Velocitat ID 4)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(630, 63, 'Cobrament', 100, 1, NULL, 30, 0, FALSE),
(631, 63, 'Llast financer', 100, 4, NULL, 20, 2, FALSE);

-- Efectes del Vi: Cura Vida i puja Atac (ID 2)
INSERT INTO Efecte (id, id_accio, nom, probabilitat, id_estadistica, id_estat, quantitat, duracio, esAfegir) VALUES 
(700, 80, 'Benedicció de salut', 100, 1, NULL, 50, 0, TRUE),
