...
public partial class AppDbContext : DbContext
{
    ...
    // NOU: Afegim el DbSet explícit per la taula intermèdia de Nivells i Ítems
    public virtual DbSet<NivellItem> NivellItems { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Nivell>(entity =>
        {
            ...
            // ELIMINAT: La configuració antiga Many-to-Many implícita que feia servir el diccionari.
        });

        // NOU: Configuració explícita de la classe NivellItem
        modelBuilder.Entity<NivellItem>(entity =>
        {
            entity.HasKey(e => new { e.IdNivell, e.IdItem })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity.ToTable("nivell_item");

            entity.HasIndex(e => e.IdItem, "id_item");

            entity.Property(e => e.IdNivell)
                .HasPrecision(3)
            ...
            entity.HasOne(d => d.IdNivellNavigation).WithMany()
                .HasForeignKey(d => d.IdNivell)
